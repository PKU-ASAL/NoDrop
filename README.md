...
We evaluated the event dropping, performance slowdown and the running overhead of NODROP by measuring its impact on the OS and on various running applications under different hardware configurations. Due to space limitations of the paper, we have included some results in **Appendix.pdf** in this GitHub repository as mentioned in pur paper. 
