...
__attribute__((__visibility__("hidden"))) void *__dlsym(void *restrict, const char *restrict, void *restrict);
...
__attribute__((__visibility__("hidden"))) ptrdiff_t __tlsdesc_static(), __tlsdesc_dynamic();

__attribute__((__visibility__("hidden"))) extern int __malloc_replaced;
__attribute__((__visibility__("hidden"))) extern int __aligned_alloc_replaced;
__attribute__((__visibility__("hidden"))) void __malloc_donate(char *, char *);
__attribute__((__visibility__("hidden"))) int __malloc_allzerop(void *);
